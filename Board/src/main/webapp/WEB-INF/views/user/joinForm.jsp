	...
	<form action="/user/join" method="POST" name="form">
		...
		<div class="form-group">
			<input name="userEmail" type="email" class="form-control"
				placeholder="Enter userEmail" required="true" />
		</div>
		<div class="form-group">
			<input name="userPassword" type="password" class="form-control"
				placeholder="Enter userPassword" required="true" />
		</div>
		<div class="form-group">
			<input type="button" class="btn btn-warning" onclick="goPopup()"value="주소검색" >
			<input id=userAddr name="userAddr" type="text" class="form-control"
				placeholder="Enter userAddr" required="true" readonly="true"/>
		</div>
