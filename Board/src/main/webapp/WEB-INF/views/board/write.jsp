...
<div class="container">
	...
	<br>
	<br>
	<form action="/writeAction" method="post" name="w_form">
		<div class="form-group">
			<input type="text" name="bTitle" class="form-control"
				placeholder="제목" id="usr">
		</div>

		<div class="form-group">
			<textarea name="bContent" id="textAreaContent" style="width: 100%"
				rows="15" cols="80">내용</textarea>



		</div>
		<input type="button" class="btn btn-success" onClick="submitContents(this)" value="작성">
	</form>
